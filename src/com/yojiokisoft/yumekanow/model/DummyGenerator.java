...
public class DummyGenerator {
	...
	public static ArrayList<Info> getInfoList() {
		...
		for (int i = 0; i < 5; i++) {
			Info info = new Info();
			info.setLabel("infomation" + i)
					.setText(
							"Information is hogehoge. Information is hogehoge. Information is hogehoge. Information is hogehoge. Information is hogehoge. Information is hogehoge.");
			list.add(info);
		}
		return list;
	}
